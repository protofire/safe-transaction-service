...
TOKEN_CACHE_TTL = env.int('TOKEN_CACHE_TTL', 86400)  # 24 hours
MAX_TRANSACTION_BATCH_SIZE = env.int('MAX_TRANSACTION_BATCH_SIZE', 1000)
TRANSACTIONS_DEFAULT_PAGE_SIZE = env.int('TRANSACTIONS_DEFAULT_PAGE_SIZE', 1000)
TRANSACTIONS_MAX_PAGE_SIZE = env.int('TRANSACTIONS_MAX_PAGE_SIZE', 10000)